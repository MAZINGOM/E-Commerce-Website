...
namespace FinalService
{
    ...
    public class Functions : IFunctions
    {
       ...
       //_________________________________   User Mangagement   ____________________________________________________________________
        ...
        public bool addAdminProducts(classAdminProducts p)
        {
            var Products = new AdminProductsTable
            {
                PrName = p.PrName,
                Price = p.PrPrice
            };

            db.AdminProductsTables.InsertOnSubmit(Products);
        ...
        public int isAdded(string name, int Price)
        {
            dynamic Added = (from p in db.AdminProductsTables
                             where p.PrName.Equals(name) && p.Price.Equals(Price)
